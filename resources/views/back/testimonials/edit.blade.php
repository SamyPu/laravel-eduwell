            ...
            <div class='col-12'>
                <div class='card'>
                    <div class='card-content'>
                        <div class='card-body'>
                            <form class='form' action='{{ route('testimonial.update', $testimonial->id) }}' method='post'>
                                @csrf
                                @method('PUT')
                                <div class='row'>
									...
									<div class='col-md-6 col-12'>
										<div class='form-group'>
											...
											<input type='text' id='first-poste-column' class='form-control' name='poste' value='{{ $testimonial->poste }}'>
										</div>
									</div>
									<div class='col-md-6 col-12'>
										<div class='form-group'>
											<label for='first-quote-column'>Quote</label>
											<input type='text' id='first-quote-column' class='form-control' name='quote' value='{{ $testimonial->quote }}'>
										</div>
									</div>
